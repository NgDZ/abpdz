...
export const abpAnimations = [
  ...
  trigger('fadeInOut', [
    ...
    transition('1 => 0', animate('225ms ease-out')),
    transition('0 => 1', animate('225ms ease-in')),
    transition('void <=> *', animate('225ms ease-in')),
  ]),
        ...
        group([
          query(
            ...
            [
              ...
              animate(
                '450ms cubic-bezier(0.0, 0.0, 0.2, 1)',
                style({
                  transform: 'translateX(-100%)',
                  opacity: 0,
                })
